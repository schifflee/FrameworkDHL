	...
	public static class WebProcess
	{
		public static WebProcessEnum Login(Services services)
		{
			try {
				...
				loginPage.OpenURL("https://citrixtest.br.phx-dc.Omni.com/Citrix/storefWeb/", services.WebService.DriverContextInfo.Timeout);
				loginPage.EfetuarLogin("andre.l.dasilva@Omni.com", "Omni@122018", services.WebService.DriverContextInfo.Timeout);
